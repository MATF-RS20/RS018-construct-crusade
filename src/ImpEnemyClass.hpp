...
public:
    ImpEnemyClass(Sprite fireball_sprite, Sprite sprite, double x_pos, double y_pos, int plat_left, int plat_right)
     : RealEnemyClass(sprite, x_pos, y_pos, plat_left, plat_right), fireball_sprite_(fireball_sprite){
